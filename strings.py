...
def main():
    ...
    datum()
    identifikator_snake = snake_case(souslovi)
    identifikatorCamel = camelCase(souslovi)
    print(identifikator_snake)
    print(identifikatorCamel)
    pocet_osob = 5

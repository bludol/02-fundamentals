...
def TypAId(studentsCount,Rating,isPublished):
    print("Typ proměnné 'students_count':", type(studentsCount))
    print("Typ proměnné 'rating':", type(Rating))
    print("Typ proměnné 'is_published':", type(isPublished))
    print("Identita proměnné 'students_count':", id(studentsCount))
    print("Identita proměnné 'rating':", id(Rating))
    print("Identita proměnné 'is_published':", id(isPublished))
    return None

TypAId(students_count, rating, is_published)
